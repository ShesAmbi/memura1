...
export default function CardsPage({ topicId = 1, telegramUserId = null }) {
  const CARDS_API = `http://localhost:8000/api/topics/${topicId}/cards/`;
  const TOGGLE_MARK_API = `/api/marks/toggle/`;
  const GET_MARKS_API = `/api/marks/?user_id=${telegramUserId}`;
